      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-5xl mx-auto px-6">
          <h1 className="text-4xl md:text-5xl font-bold text-center mb-6">
            Packers and Movers Rai, Sonipat – Factory & Home Shifting
          </h1>
          <p className="text-center text-xl text-gray-700 mb-10">
            Specialised in Rai Industrial Area | Warehouse | Godown | Office | Home Relocation
          </p>

          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              <h3 className="text-2xl font-bold text-green-600">₹6,000+</h3>
              <p className="text-gray-700">1BHK / Few Items in Rai</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              <h3 className="text-2xl font-bold text-green-600">₹15,000+</h3>
              <p className="text-gray-700">Factory Machinery Shifting</p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              <h3 className="text-2xl font-bold text-green-600">24×7</h3>
              <p className="text-gray-700">Service in Rai Industrial Area</p>
            </div>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul>
              <li>Few items / 1 room → ₹6,000 – ₹9,000</li>
              <li>Complete 2BHK house → ₹9,000 – ₹14,000</li>
              <li>Factory machinery (per truck) → ₹15,000 – ₹40,000</li>
              <li>Warehouse to warehouse → Price on inspection</li>
              <li>Rai to Delhi → ₹8,000 – ₹15,000</li>
            </ul>
